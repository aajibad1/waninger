...
def attrib(default=NOTHING, validator=None,
    ...
    :param callable converter: :func:`callable` that is called by
        ``attrs``-generated ``__init__.py`` methods to converter attribute's value
...
def _add_init(cls, frozen):
    """
    Add a __init__.py method to *cls*.  If *frozen* is True, make it immutable.
    """
